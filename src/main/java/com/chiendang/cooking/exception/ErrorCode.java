...
public enum ErrorCode {
    ...
    RECIPE_NOT_FOUND(1002, "Movie is not found", HttpStatus.NOT_FOUND),
    ...
    USER_EXISTED(1014,"You do not have permission",HttpStatus.FORBIDDEN),
    USER_NOT_EXISTED(1015,"You do not have permission",HttpStatus.FORBIDDEN)
